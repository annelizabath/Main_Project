...
$sqlData="SELECT rent FROM `tbl_book` WHERE lid='$id'";
...
<div class="main">	
		...
		<ul>
			<li>
				...
				<div class="nl-content">
					...
					<form action="pay.php" method="post" class="creditly-card-form agileinfo_form">
						<section class="creditly-wrapper wthree w3_agileits_wrapper">
								<div class="first-row form-group">
								<div class="controls">
										<label class="control-label">Amount</label>
										<input type="text" name="number" value="<?php echo $amnt;?>" readonly="">
									</div>
									<div class="controls">
									...
									<div class="controls">
										...
										<input  type="text" name="cnumber" placeholder="&#149;&#149;&#149;&#149; &#149;&#149;&#149;&#149; &#149;&#149;&#149;&#149; &#149;&#149;&#149;&#149;" required="">
									</div>
									<div class="w3_agileits_card_number_grids">
										...
										<div class="w3_agileits_card_number_grid_right">
											<div class="controls">
												...
												<input  type="text" name="security-code" placeholder="&#149;&#149;&#149;" required="">
											</div>
										</div>
									</div>
								</div>
								<!-- <button class="submit" name="submit" type="submit"><span>Make a payment </button> -->
								<input type="submit" name="submit" onclick="cardnumber(document.form1.text1)"value="make payment">
						</section>
					</form>
					</div>	
				</div>
	...
	<div class="agileits_copyright">
		<p>© 2017 Card Payment Forms. All rights reserved.</p>
	</div>
</div>
<!-- js scripts --> 
<!-- js -->
