            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div class="row">
                        ...
                        <!-- ./col -->
                        <?php
                        $q = "SELECT * FROM `tbl_staff_reg` WHERE status='pending'";
                        $data = mysqli_query($con, $q) or die(mysqli_error($con));
                        $r = mysqli_fetch_array($data);

                        $res = "SELECT * FROM `tbl_designation` WHERE des_id='$r[8]'";
                        $data1 = mysqli_query($con, $res) or die(mysqli_error($con));
                        $r1 = mysqli_fetch_array($data1);

                        $result = "SELECT * FROM `tbl_qualification` WHERE q_id='$r1[1]'";
                                    ...
                                    <table id="customers" align="center">
                                        ...
                                        while ($r = mysqli_fetch_array($data)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="approve.php?id=<?php echo $r['staff_id']; ?>"> verify</a></td>
                                            </tr>
                                            <?php
                                        }
                                        ?>
