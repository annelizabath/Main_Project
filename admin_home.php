...
<link href="admin/css/fullcalendar.min.css" rel="stylesheet">
<link href="admin/css/jquery.mCustomScrollbar.min.css" rel="stylesheet">
...
<header id="header" class="clearfix" data-spy="affix" data-offset-top="65">
  <ul class="header-inner">
    ...
    <!-- Logo -->
    <li class="logo"> <a href="admin_home.php"><img src="admin/img/logo11.png" alt="Bethlehem"></a>
    ...
    <li class="dropdown"> <a href="#" data-toggle="dropdown" class="hi-messages"> <i class="jtv jtv-email"></i> <i class="hi-count">6</i> </a>
      <div class="dropdown-menu hi-dropdown">
        ...
        <div class="list-group lg-alt"> <a class="list-group-item media" href="#">
          <div class="pull-left"> <img class="img-avatar" src="admin/img/profile-pics/1.jpg" alt="" width="40" height="40"> </div>
          ...
          <div class="pull-left"> <img class="img-avatar" src="admin/img/profile-pics/5.jpg" alt="" width="40" height="40"> </div>
          <div class="media-body">
          ...
          <div class="pull-left"> <img class="img-avatar" src="admin/img/profile-pics/2.jpg" alt="" width="40" height="40"> </div>
          <div class="media-body">
          ...
          <div class="pull-left"> <img class="img-avatar" src="admin/img/profile-pics/4.jpg" alt="" width="40" height="40"> </div>
          <div class="media-body">
    ...
    <li class="dropdown"> <a href="#" data-toggle="dropdown" class="hi-notifications"> <i class="jtv jtv-notifications"></i> <i class="hi-count">9</i> </a>
      <div class="dropdown-menu hi-dropdown">
        ...
        <div class="list-group lg-alt"> <a class="list-group-item media" href="#">
          <div class="pull-right"> <img class="img-avatar" src="admin/img/profile-pics/1.jpg" alt="" width="40" height="40"> </div>
          <div class="media-body">
          ...
          <div class="pull-right"> <img class="img-avatar" src="admin/img/profile-pics/4.jpg" alt="" width="40" height="40"> </div>
          <div class="media-body">
            <div class="list-group-item-heading">Charlie Adams <small>07/09/2018</small></div>
            <small class="list-group-item-text c-gray">Duis tincidunt augue nec sem dignissim scelerisque. Vestibulum rhoncus sapien sed nulla aliquam lacinia</small> </div>
          </a> <a class="list-group-item media" href="#">
          <div class="pull-right"> <img class="img-avatar" src="admin/img/profile-pics/2.jpg" alt="" width="40" height="40"> </div>
          <div class="media-body">
    ...
    <li class="hidden-xs dropdown pull-right"> <a href="#" data-toggle="dropdown"> <i class="jtv jtv-apps"></i> </a>
      <div class="dropdown-menu pull-right" id="launch-apps">
        <div class="dropdown-header bg-teal">Practo APPS</div>
        <div class="la-body">
...
<aside id="sidebar"> 
  ...
  <!--| MAIN MENU |-->
  <ul class="side-menu">
    <li class="sm-sub sms-profile"> <a class="clearfix" href="#"> <img src="admin/img/profile-pic.jpg" alt=""> <span class="f-11"> <span class="d-block">Admin</span> <small class="text-lowercase">admin@gmail.com</small> </span> </a>
      <ul>
        <!-- <li><a href="admin_view.php">View Profile</a></li> -->
        <li><a href="logout.php">Logout</a></li>
      </ul>
    </li>
    <li class="active"> <a href="admin_home.php"> <i class="jtv jtv-home"></i> <span>Home</span> </a> </li>

    <li class="sm-sub"> <a href="#"> <i class="jtv jtv jtv-view-list"></i> <span>View</span> </a>
      <ul>
        <li><a href="admin_view_staff.php">View staff</a></li>
        <!-- <li><a href="admin_view_user.php">View approved users</a></li> -->
        <!-- <li><a href="admin_view_block_user.php">View blocked users</a></li>  -->
        <li><a href="admin_view_owner.php">View owners</a></li>
        <!-- <li><a href="admin_view_inmate.php">View approved inmates</a></li> -->
        <!-- <li><a href="admin_view_booked_inmate.php">View booked inmates</a></li> -->
        <!-- <li><a href="admin_view_block_inmate.php">View blocked inmates</a></li> -->
      </ul>
    </li>
    <li class="sm-sub"> <a href="#"> <i class="jtv jtv jtv-view-list"></i> <span>View Status</span> </a>
      <ul>
        <!-- <li><a href="admin_view_staff.php">View staff</a></li> -->
        <li><a href="admin_view_user.php">View approved users</a></li>
        <li><a href="admin_view_block_user.php">View blocked users</a></li>
    ...
    <li class="sm-sub"> <a href="#"> <i class="jtv jtv-collection-text"></i> <span>Pendings <span class="label label-warning">New</span></span> </a>
      <ul>
        <li><a href="pending_user.php">Users</a></li>
      </ul>
    </li>
    <li class="sm-sub"> <a href="#"> <i class="jtv jtv-swap-alt"></i> <span>Owner</span> </a>
      <ul>
        <li><a href="owner_reg.php">Add Owner</a></li>
      </ul>
    </li>
    ...
    <div class="overview row">
      <div class="col-md-3 col-sm-6">
        <div class="o-item bg-cyan">
          <div class="oi-title"> <span data-value="450382"></span> <span>Website Traffic</span> </div>
          <div class="overview-chart-line text-center"><!-- 9,5,6,3,9,7,5,4,6,5,6,4,9 --></div>
        </div>
      </div>
      <div class="col-md-3 col-sm-6">
        <div class="o-item bg-amber">
          <div class="oi-title"> <span data-value="8737"></span> <span>Total Visitors</span> </div>
      ...
      <div class="col-md-3 col-sm-6">
        <div class="o-item bg-bluegray">
          <div class="oi-title"> <span data-value="452"></span> <span>Supporters</span> </div>
        ...
        <div class="tile">
          ...
          <div class="t-body">
            <div class="main-chart p-t-25">
              ...
              <div class="mc-info hidden-xs"> <span>1418 <i class="jtv jtv-caret-up-circle"></i></span> <small>Praesent tempor erat eget risus vehicula in maximus turpis</small> </div>
            </div>
          </div>
        </div>
            ...
            <div class="bg-blue count-box">
              <div class="row">
                <div class="col-sm-3 col-xs-6">
                  <div class="cb-item">
                    <h3>298K</h3>
                    <small>Previous Month</small> </div>
                </div>
                <div class="col-sm-3 col-xs-6">
                  <div class="cb-item">
                    <h3>87K</h3>
        ...
        <div class="tile">
          ...
          <div class="t-body">
            <div class="list-group lg-alt"> <a href="#" class="list-group-item media">
              <div class="pull-left"> <img class="img-circle pull-left" src="admin/img/profile-pics/1.jpg" alt="" width="40" height="40"> </div>
              <div class="media-body">
              ...
              <div class="pull-left"> <img class="img-avatar" src="admin/img/profile-pics/3.jpg" alt="" width="40" height="40"> </div>
              <div class="media-body">
                <div class="list-group-item-heading">User Name</div>
...
<script src="admin/js/bootstrap-growl.min.js"></script> 
<script src="admin/js/jquery.mCustomScrollbar.concat.min.js"></script> 
