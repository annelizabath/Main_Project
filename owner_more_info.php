...
while($r=mysqli_fetch_array($data)){
    ?>
<table align="center" id="table" border="4" width="50%">
  <thead>
      ...
      <th scope="col">Lisence Proof </th><td><img src="<?php echo $r['proof'];?>"height="100px" width="100px"/></td></tr>
      <th scope="col">Photo </th><td><img src="<?php echo $r['photo'];?>"height="100" width="100" /></td></tr>
      <th scope="col">Signature </th><td><img src="<?php echo $r['signature'];?>"height="100" width="100"/></td></tr>
      <th scope="col">Description </th><td><?php echo $r['message'];?></td></tr>
      <!-- <td colspan="2" style="align:center"><input type="submit" name="submit" value="DELETE"></td> -->
  </thead>
</table>
<?php
}
